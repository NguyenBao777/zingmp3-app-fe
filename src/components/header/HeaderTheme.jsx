...
const HeaderTheme = () => {
    ...
    return (
        ...
        <>
            <header className="w-full flex items-center justify-between px-2 py-1 gap-4 bg-headerColor fixed top-0 right-0 drop-shadow-md z-20">
                <Link to="/">
                    <img src={LogoLarge} alt="logo" className="object-cover w-225" />
                </Link>
