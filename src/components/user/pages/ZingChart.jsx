    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full flex flex-wrap justify-center gap-4 mt-4">
                <div className="w-full lg:w-[30%] bg-gradient-to-b from-primary to-headerColor rounded-md p-2 flex flex-col items-center gap-2">
                ...
                <div className="w-full lg:w-[30%] bg-gradient-to-b from-primary to-headerColor rounded-md p-2 flex flex-col items-center ">
                    <div className="group flex items-center gap-4 w-full justify-center cursor-pointer"
